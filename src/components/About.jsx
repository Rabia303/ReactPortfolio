...
import { ABOUT_TEXT } from "..";
import { 
  FaUser, FaCode, FaTrophy, FaRocket, FaMobile, 
  FaDatabase, FaGlobe, FaAward, FaGraduationCap 
} from "react-icons/fa";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="block lg:hidden">
          <div className="flex flex-col items-center">
            <img
              className="rounded-2xl mb-6 w-3/4"
              src={AboutImage}
              alt="Personal"
            />
            <div className="text-neutral-400 text-center">
              {ABOUT_TEXT.split("\n").map((line, index) => {
                ...
                if (
                  ["What I Do", "Who I Am", "What I’m Working On", "Hackathon Adventures"].includes(trimmedLine)
                ) {
                  return (
                    <h2 key={index} className="mb-3 text-xl font-bold text-neutral-300">
                      {trimmedLine}
                    </h2>
                  );
                }
                ...
                if (trimmedLine.startsWith("-")) {
                  return (
                    <li key={index} className="list-disc ml-6 mb-2 text-neutral-300">
                      {trimmedLine.slice(1).trim()}
                    </li>
                  );
                }
        ...
        {/* ---------- Desktop Version ---------- */}
        <div className="hidden lg:flex flex-row items-stretch gap-8">
          {/* Image Section */}
          <div className="w-1/2 lg:p-8 flex justify-center">
            <img
              className="rounded-2xl"
              src={AboutImage}
              alt="Personal"
